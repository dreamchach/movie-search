      ...
      <svg id="ufo-image" viewBox="0 0 2303 1630" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="gogo_UFO">
          <path id="cloud"
            ...
            fill="#0A0228" />
          <UFOBeam d="M1143.5 497L1509 1474H1143.5H778L1143.5 497Z" fill="#9670BA" />
          <path id="4-L"
          ...
          <Star8 cx="621.172" cy="516.172" r="14.1716" fill="white" />
          <Star7 cx="667.172" cy="1138.17" r="14.1716" fill="white" />
          <Star6 cx="1814.82" cy="800.974" r="14.1716" fill="white" />
          <Star5 cx="265.172" cy="829.172" r="14.1716" fill="white" />
          <circle id="star_4" cx="565" cy="1073" r="9" fill="white" />
          <Star3 cx="1844.55" cy="659.95" r="7.94992" fill="white" />
          ...
          <g id="alien">
            ...
            <Hand d="M1077.07 400.9C1078.47 405.192 1082.03 412.875 1092.04 416.39" stroke="#B5F7C3"
              stroke-width="12" stroke-linecap="round" />
            <Hand d="M1225.41 436.218C1229.9 435.767 1240.03 429.375 1243.72 424.875" stroke="#B5F7C3"
              stroke-width="12" stroke-linecap="round" />
          </g>
          <g id="UFO">
            <path id="Vector"
...
`
const shakingUpAndDown = keyframes`
from {
...
transform-origin : center;
`
const UFOBeam = styled.path`
animation-name : ${expandHorizontal};
animation-duration : 3.5s;
transform-box : fill-box;
transform-origin : center;
`
const Number0 = styled.path`
animation-name : ${appearFromBottom};
animation-duration : 3s;
`
const Hand = styled.path`
animation-name : ${shakingUpAndDown};
